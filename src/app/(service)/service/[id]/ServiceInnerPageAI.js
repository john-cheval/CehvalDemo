  ...
  return (
    <>
      ...
      <SectionHero
        ...
        bannerImg={pageData?.service_banner}
        bannerVideo={pageData?.service_video}
      ...
      {pageData?.section_for_landing_marketing &&
        pageData?.section_for_landing_marketing.length > 0 && (
          <div className="bg-white">
            {pageData?.section_for_landing_marketing?.map((section, index) => {
              switch (section?.section_type) {
                case "ourservices":
...
export default ServiceInnerPageAI;
