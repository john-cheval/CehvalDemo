  ...
  return (
    <div className="relative w-screen h-fit bg-white overflow-x-hidden">
      <div className="relative max-w-screen mx-auto w-full">
        <div className="w-full flex items-center py-10 sm:py-20 md:py-24 h-fit flex-col wrapper-padding  ">
                  ...
                  <div className="flex flex-col  sm:items-start group items-center sm:justify-start justify-center  overflow-hidden   h-fit space-y-4">
                    ...
                    <div>
                      ...
                      <Link
                        ...
                        className="text-xs my-3 text-center md:text-left group-hover:text-[#D81100] transition-all duration-300 text-black border-b border-b-black group-hover:border-b-sec w-fit pb-[2px]"
                      >
                        Explore
                      </Link>
                    </div>
