    ...
    <div className="relative w-screen h-fit  py-8-- sm:pt-14 md:pt-16 bg-white overflow-x-hidden">
      <div className="relative max-w-screen wrapper-padding sm:py-0 py-10 w-full">
        <div className="grid grid-cols-3 gap-5 w-full h-fit">
          <div className=" col-span-3 xl:col-span-1 xl:pr-[20%]">
            <h4
              style={{}}
              className="font-sora font-semibold text-[#101763] text-3xl lg:text-4xl  !leading-[130%] text-center xl:text-left"
            >
              <span
                style={{
                  background:
            ...
            <div className="my-5 xl:ml-1 w-full max-w-32 h-[1px] bg-black mx-auto "></div>
          </div>
